...
* **Two themes**: I made a bright theme in addition to the original theme. I was in a rush, but if there are a decent number of players, I will add some better ones. For the code though, two themes are enough to demonstrate how to do themes (the brute force way).
